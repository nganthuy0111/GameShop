...
public class FragmentAdminProducts extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new ProductAdminAdapter(requireContext(), productList);
    ...
    private void showAddProductDialog() {
        View dialogView = LayoutInflater.from(requireContext()).inflate(R.layout.dialog_product_form, null);
